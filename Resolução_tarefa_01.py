...
def main():
    ...
    st.set_page_config(page_title = 'Loan Concession Analysis', \
        page_icon = '../img/concessao-de-credito.jpg',
        layout="wide",
        initial_sidebar_state='expanded'
    )

    # Título principal da aplicação
    st.write('# Loan Concession Analysis')
    st.markdown("---")
    
    # Apresenta a imagem na barra lateral da aplicação
    image = Image.open("../img/concessao-de-credito-sidebar.jpg")
